...
public class Phone_Create_Interface extends Commodity_Create implements Merchandise_Expiration_Date {
    ...
    // 构造方法
    public Phone_Create_Interface(String Pro_name, String Pro_id, int Pro_count, double Pro_purchaseprice,
    ...
    public double leftActualValue(double leftDatePercent) {
        return getPro_soldprice()*leftDatePercent*0.8;
    }
